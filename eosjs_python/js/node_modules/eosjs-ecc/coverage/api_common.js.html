...
ecc.randomKey().then(privateKey =&gt; {
  ...
  console.log('Public Key:\t', ecc.privateToPublic(privateKey)) // EOSkey...
    ...
    */
    randomKey: <span class="fstat-no" title="function not covered" >(c</span>puEntropyBits) =&gt; (
<span class="cstat-no" title="statement not covered" >      PrivateKey.randomKey(cpuEntropyBits).then(<span class="fstat-no" title="function not covered" >ke</span>y =&gt; <span class="cstat-no" title="statement not covered" >key.toString())</span></span>
    ),
&nbsp;
    /**
&nbsp;
